...
> **Исторический дизайн-док** (этап проектирования, до V1). Часть деталей
> устарела (SSE — не реализован, polling; список моделей — см. актуальный
> в README; контракт HTTP — см. [`PROJECT_OVERVIEW.md`](PROJECT_OVERVIEW.md) §5).
> При расхождениях источник истины — `PROJECT_OVERVIEW.md`.
